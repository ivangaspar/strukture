...
int main()
{
	...
	while (izbor)
	{
		puts("unesite izbor:1-unos elementam, 2-print ,3-obrisati element,4-pronaci element, 5-exit");
		scanf("%d", &izbor);
		...
		case 2:
			...
			break;
		case 3:
			puts("unesite broj koji zelite izbrisati: ");
			scanf("%d", &broj);
